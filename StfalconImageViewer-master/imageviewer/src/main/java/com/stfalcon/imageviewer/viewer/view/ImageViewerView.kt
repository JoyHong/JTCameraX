...
//            println("~~~~~~position=${imagesPager.currentItem}")
//            println("~~~~~~${imagesAdapter?.getItemViewRatio(imagesPager.currentItem)}")
