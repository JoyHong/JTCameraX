...
object Demo {
    ...
    val posters = listOf(
        //经典横向
        //$POSTERS_PATH/VCG41N1272819263.jpg
        //经典竖向
        //https://pic2.zhimg.com/v2-d5fb43450e38fc351d70795495485d25_r.jpg
        //特殊情况
        //https://www.shijuepi.com/uploads/allimg/200821/1-200R1141258.jpg

//        Poster(url = "$POSTERS_PATH/VCG41N1278720325.jpg", description = "Vincent Vega is a Whitman and associate of Marcellus Wallace. He had a brother named Vic Vega who was shot and killed by an undercover cop while on a job. He worked in Amsterdam for over three years and recently returned to Los Angeles, where he has been partnered with Jules Winfield.",imageType = 1),
        Poster(url = "https://pic2.zhimg.com/v2-ba225cba1b7351faf4238fd514a96539_r.jpg?source=1940ef5c", description = "Jules Winfield - initially he is a Hitman working alongside Vincent Vega but after revelation, or as he refers to it \"a moment of clarity\" he decides to leave to \"Walk the Earth.\" During the film he is stated to be from Inglewood, California",viewType = RecyclingPagerAdapter.VIEW_TYPE_IMAGE),
        ...
        Poster(url = "https://pic2.zhimg.com/v2-d5fb43450e38fc351d70795495485d25_r.jpg", description = "Dominic \"Dom\" Toretto is the brother of Mia Toretto, uncle to Jack and husband to Letty Ortiz. The protagonist in The Fast and the Furious franchise, Dominic is an elite street racer and auto mechanic.",viewType = RecyclingPagerAdapter.VIEW_TYPE_IMAGE),
        Poster(url = "https://pic2.zhimg.com/v2-17b3c9ffd8c7ec7f06b50961537ff35c_r.jpg?source=1940ef5c", description = "Martin Seamus \"Marty\" McFly Sr. - he is the world's second time traveler, the first to travel backwards in time and the first human to travel though time. He was also a high school student at Hill Valley High School in 1985. He is best friends with Dr. Emmett Brown, who unveiled his first working invention to him.",viewType = RecyclingPagerAdapter.VIEW_TYPE_IMAGE),
