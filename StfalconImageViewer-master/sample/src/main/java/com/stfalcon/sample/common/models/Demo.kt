...
object Demo {
    ...
    val urlstaring="https://th.bing.com/th/id/R.9942ee1d27d2d4c7774218ab211972d7?rik=bYsVWXyn1y%2f6Ig&riu=http%3a%2f%2f222.186.12.239%3a10010%2fwmxs_161205%2f004.jpg&ehk=AXJmZ28xMAJai5DRQyBgIwAfrDQlurPUq3D%2fLFaDoHs%3d&risl=&pid=ImgRaw&r=0"
    val posters = listOf(
        //经典横向
...
//        Poster(url = "$POSTERS_PATH/VCG41N1278720325.jpg", description = "Vincent Vega is a hitman and associate of Marsellus Wallace. He had a brother named Vic Vega who was shot and killed by an undercover cop while on a job. He worked in Amsterdam for over three years and recently returned to Los Angeles, where he has been partnered with Jules Winnfield.",imageType = 1),
        ...
        Poster(url = urlstaring, description = "Dominic \"Dom\" Toretto is the brother of Mia Toretto, uncle to Jack and husband to Letty Ortiz. The protagonist in The Fast and the Furious franchise, Dominic is an elite street racer and auto mechanic.",viewType = RecyclingPagerAdapter.VIEW_TYPE_IMAGE),
        Poster(url = urlstaring, description = "Martin Seamus \"Marty\" McFly Sr. - he is the world's second time traveler, the first to travel backwards in time and the first human to travel though time. He was also a high school student at Hill Valley High School in 1985. He is best friends with Dr. Emmett Brown, who unveiled his first working invention to him.",viewType = RecyclingPagerAdapter.VIEW_TYPE_IMAGE),
